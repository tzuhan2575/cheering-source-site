...
領取條件：出示此文章畫面，並持有演唱會門票以及官方周邊可領取。

2. 看著我也看著你－TWICE 全員大頭照
讓成員盯著你看的感覺是不是很幸福？
每個成員會有一個被標記，抽到即可獲得吊飾。
領取條件：出示此文章畫面，並持有演唱會門票以及官方周邊可領取。

3. 要多閒有多賢－TWICE 多賢貼紙或照片
自己設計的多賢美照貼紙、人生四格吊飾。
領取條件：出示此文章畫面，並持有多賢官方周邊（如 DAVELY、泡泡）可領取。
...
日期：3/20、3/21、3/22
完整時間與地點將另行公布
追蹤脆與 IG @aboutzu0422 得到第一手消息。

領取方式：
證明你是 ONCE 之外，請帶著這篇貼文展示給我看！
並且務必有玩 Switch 才進行領取。
一個成員 20 個，數量有限。
...
日期：3/20、3/21、3/22
完整時間與地點另行公布，追蹤脆與 IG @aboutzu0422 得到第一手消息。

領取方式：
證明你是 ONCE。
一款準備 100 個，總共 200 個，數量有限，一個人隨機發放一種。
...
1. 拉霸機玩具 300 個
2. 九宮格拍貼書籤 300 份
3. Be as One 手提紙袋 300 個
4. Lovelys 刺青小貼紙 300 張

以上四個品項各 1 為一套。
每天都會發放限量 100 套，會直接給你一個精美的紙袋裝著應援物。

拉霸機玩具兩款：
ENEMY 款式 150 個
Feel Special 款式 150 個

九宮格拍貼書籤四款：
Strategy 款式 75 份
Timeless Black 款式 75 份
THIS IS FOR 款式 75 份
ENEMY 款式 75 份
...
2. 豆豆眼娃帽 × 1（9 色可選），每日九份

領取條件
1. 御守 + 貼紙：門票 + 紗紗泡泡 + Savely 娃
2. 豆豆眼娃帽：門票或粉絲證明即可
...
這次應援主要以交換為主，有剩的會演唱會當天發放，也有少數的線上名額，想要領取的可以私訊我。

本命是娜璉，所以有娜璉的特別款。

應援物：糖果袋
數量：
一般款 50 份（一個成員各五份，會多給其他成員吊飾可以替換）
娜璉特別款 10 份（限交換）
...
領取條件：
身上有 5 個以上 Lovelys 或成員泡泡訂閱 100+ 天，並示出此貼文

2. 拉芙哩透明貼紙（2 款隨機）約 150 份
領取條件：
身上有 3 個以上 Lovelys 並示出此貼文

時間：
3/20、3/21、3/22 每天定量，不會開線上

地點：
不固定，會跟朋友一起晃大巨蛋，遇到即是緣分
當天會在此貼文留言置頂穿搭，如果當天無餘量會典藏穿搭照
...
領取方式：
3/20 由 @decade_1221 負責發放
3/21 由我負責，大約會在下午 2-3 點
3/21 當天會在本貼文留言處張貼發放的位置及穿著，或是在路上找到我本人，出示自己是 ONCE 的證明即可領取
...
・杯墊 × 10
・鑰匙圈兩款，共 20 個
另外有 10 週年 Savely 鑰匙圈 × 2

發放方式
採用轉盤抽獎
每個應援物都會事先編號，當天使用手機隨機抽號，抽到幾號就能領取對應的應援物。

領取條件
出示 3/20、3/21、3/22 任一天演唱會門票
官方 LOVELY 或手燈擇一
...
應援內容：
迷你 CD 盒掛飾，志效、多賢兩款各 20 份（交換為主）
樂團 Lovely 貼紙（公開領取）

領取條件：
CD 盒掛飾需出示任何志效或多賢官方周邊、粉絲證明
貼紙出示粉絲證明即可領取
...
1. 團體小手持鏡＋珠鍊吊飾
2. 子瑜鏡子鑰匙圈 2 款
這 2 款正面皆為 58mm 胸章、背面為鏡子
3. 高雄場來不及發完的壓克力吊飾 3 款隱藏版
以及隨機發放自印小卡、貼紙
...
因為製作成本比較高，數量準備得不多，會以交換應援為主。
如果當天有多的，會隨機發放給顯眼的萬斯們。

發放日期：
3/20（彩排可約場內）、3/21

款式：
Posing topper｜13 公分｜9 款 × 各 5 個
Heart topper｜8 公分｜9 款 × 各 5 個
...
3/21、3/22 領取方式：
不織布提袋僅限現場交換，交換地點之後會公布，請私訊我。

圖二的應援物活動當天看到我也可以直接來找我拿。
...
現場交換可以私訊我約時間：3/21、3/22。`,
  ...
  },
  {
    id: "item_118",
    creator: "@jype_atm2",
    creatorUrl: "https://www.threads.com/@jype_atm2",
    types: ["吊飾"],
    title: "THIS IS FOR IN TAIPEI｜應援色吊飾",
    postUrl:
      "https://www.threads.com/@jype_atm2/post/DV6Bl3PgbaG?xmt=AQF03bUE0b6R8nokhoVeREs-NA6BrAEuOnZkKUKHSXh5ag",
    postContent: `THIS IS FOR IN TAIPEI 應援

這是 TWICE 第一次在台北大巨蛋舉辦演唱會，為了紀念這個特別的時刻，我準備了應援色吊飾，想和 ONCE 們一起交換禮物、留下回憶。

應援物：應援色吊飾
預計發放日期：3/21、3/22
發放時間與地點：將於當日另行公告
領取方式：出示 ONCE 5期會員或官方周邊娃娃即可領取

希望能和大家一起在台北留下美好的演唱會回憶，歡迎 ONCE 們來交換小禮物，我們一起大聲應援。`,
    images: ["/item_118_01.jpeg", "/item_118_02.jpeg"],
  },
  {
    id: "item_119",
    creator: "@thor_wsq",
    creatorUrl: "https://www.threads.com/@thor_wsq",
    types: ["其他"],
    title: "TWICE THIS IS FOR WORLD TOUR in Taipei｜飄帶應援",
    postUrl:
      "https://www.threads.com/@thor_wsq/post/DV6IIW_D0CA?xmt=AQF0d-De9njnFnGBmnuwww2IRRX2F5L_IGMdwnIJpqkfJg",
    postContent: `TWICE THIS IS FOR WORLD TOUR in Taipei 飄帶應援發放公告

這次台北場有 1600 條飄帶。
應援物為 TWICE 演唱會台北場應援飄帶，各成員應援色 9 人 9 色，加上 THIS IS FOR 經典藍白配色 2 款，共 11 款，這次會包裝起來讓大家隨機抽，兩天各發 800 條。

發放時間地點：
3/21 14:00 開始發放
3/22 14:00 開始發放
地點：大巨蛋後方靠近光復南路側，青花驕斜對面

領取條件：
請出示 TWICE 官方小卡，正版授權的都可以，自印不算，且需配合出示背面。

注意事項：
一人限領一份，請不要重複拿取
包裝袋請勿亂丟
如果沒拿到想要的款式，也可以現場跟其他 ONCE 交換。`,
    images: [
      "/item_119_01.jpeg",
      "/item_119_02.jpeg",
      "/item_119_03.jpeg",
  ...
  },
  {
    id: "item_120",
    creator: "@_yong.xiang",
    creatorUrl: "https://www.threads.com/@_yong.xiang",
    types: ["其他"],
    title: "TWICE THIS IS FOR WORLD TOUR IN TAIPEI｜手提牛皮紙袋",
    postUrl:
      "https://www.threads.com/@_yong.xiang/post/DV6Hhkhj8uf?xmt=AQF0ikoIAcdp1vIskP_kzsk_0oFv0_q2_WLsy4QrdD1Tbw",
    postContent: `TWICE THIS IS FOR WORLD TOUR IN TAIPEI 台北場免費應援發放

應援物：
手提牛皮紙紙袋，尺寸符合入場限制（20x11x27cm），可以用來裝滿滿的應援物。

發放日期：
3/20、3/21、3/22
發放時間、地點及穿著都會當天公布在留言區
...
交換應援
出示官方周邊（手燈、Lovely 娃等）
泡泡合計 100 天以上，或五期會員，或日本會員

注意事項：
禁止販賣、銷售、抄襲本應援物
一人一份，不可代領
禁止拿此應援物與他人交換應援。`,
    images: ["/item_120_01.jpeg", "/item_120_02.jpeg"],
  },
  {
    id: "item_121",
    creator: "@once.fortwice.23",
    creatorUrl: "https://www.threads.com/@once.fortwice.23",
    types: ["吊飾", "鑰匙圈", "貼紙", "其他"],
    title: "台北場應援｜手作吊飾、開罐器鑰匙圈與貼紙",
    postUrl:
      "https://www.threads.com/@once.fortwice.23/post/DV6GMoUkha8?xmt=AQF0ymoShbSs03n7YFUDm__420KconGTGN6iU76sAeIDcw",
    postContent: `終於要來好好發一篇。

3/20 會跟 @engoil_0201 一起行動，3/21、3/22 我也都會到場。
...
地點：
預計是大家都會在的連通道，抵達後會再公布，會在這篇貼文置頂留言

有跟我們交換應援的萬斯們，或想找到我們的大家，方便當天聯繫有開一個 LINE 匿名社群。

注意事項：
現場發放不挑成員
每人限領一份
請勿丟棄、代領、轉售給別人。`,
    images: ["/item_121_01.jpeg", "/item_121_02.jpeg", "/item_121_03.jpeg"],
  },
  {
    id: "item_122",
    creator: "@cubmumu",
    ...
    postContent: `這次沒時間鉤織應援小物，所以做了小小應援胖胖筆，讓我自己放在身上，隨時回想看演唱會那天的美好，也想分享給大家。

在路上發現 ONCE，我會偷偷塞給你們，希望我可以發得完。`,
    images: ["/item_122_01.jpeg"],
  },
  {
    id: "item_123",
    creator: "@13__wei",
    creatorUrl: "https://www.threads.com/@13__wei",
    types: ["其他"],
    title: "This is for twice in Taipei｜戒指與手飾",
    postUrl:
      "https://www.threads.com/@13__wei/post/DV5-mG8FE0N?xmt=AQF0koHn36nwKPyJcjUyLOtp_T9ZMhbI44v0TvvVohWwdQ",
    postContent: `This is for twice in Taipei

經過幾週的奮戰終於包裝好了應援小物。
第一次做應援，應該會找個角落發，希望大家有禮貌地來找我領取或交換。
...
發放物：
1. MISAMO + 戒指（各 30 個）
2. MISAMO + 其他成員手飾（各 10-15 組）

補充：
如果週六發完的話，週日就可能不會發。
如果有特別喜歡的 ONCE 可以留言款式，會幫你保留。`,
...
應援物資訊：
行李吊牌（全新製作）：1 款，共 40 份
吉他撥片吊飾（高雄場餘量）：共 9 款，每款只剩一、兩個

領取條件：
需出示任何可證明是 ONCE 的物品，例如官方手燈、官方周邊、小卡等
...
發放日期時間地點：
3/20-3/22 三天都會到，但主要發 3/22
大巨蛋外，到時候會再更新穿搭跟地點

領取資格：
交換應援優先
看得出來是 once / 出示任一 lovely / 官方小卡 / 手燈以外的周邊
...
發放日期：3/22
發放時間：約 14:00（看當日情況調整）
發放位置：大巨蛋外，當天會公告位子及穿著
...
領取方式：
因為數量不多，希望真粉可以拿到不要浪費。
到時候會在 Threads 發當天服裝，我會在場外隨便走，認出來的人可以直接來找我。
需要有粉絲證明，例如手燈、泡泡 50 天以上或任何周邊衣服、娃娃之類的。
出示粉絲證明跟應援貼文就可以領取。
...
應援物說明：
1. 便條紙：十週年成員 9 款 + Lovely 便條紙 3 款
2. 透明御守貼紙：子瑜 + 紗瑜款，共 8 款
3. 應援筆（數量少，只限交換）
...
時間與地點：
3/21 會在此帳號公布詳細資訊，有可能會到處走走

領取方式 / 條件：
1. 目前想以交換為主，若有多的會開放免費領取
2. 當天領取只要看得出來是 ONCE 就好
3. 想交換的可以私訊我，會幫您保留名額
...
領取條件：
出示此貼文（可截圖）+ 粉絲證明（成員泡泡、lovely 官方周邊）
即可獲得該成員吊飾
數量有限，一人限領一份

份數：
20 份
從撕棉花、摺紙星星、剪貼紙到綁緞帶都是純手工
目前預計各成員 1～2 份，子瑜的會比較多
...
應援禮：
徽章藥片
可以直接當吊飾掛在包包上，也可以拆開變成徽章別在任何地方。

份數：25 份
免費領取

時間：3/21
地點：台北大巨蛋（詳細時間地點當天會再公告）
...
膠片特殊規則：
需出示此貼文，並展示米彩官方周邊，抽選方式取得

發放時間及地點：
3/20～3/22 都會在大巨蛋附近亂跑
實時位置當日會發布在這篇貼文底下並置頂
目前確定 3/21 早上會在松山文創園區
...
3/20、3/21、3/22 都會在現場發。
每天 45 個，發完就休息了。

領取條件：
出示泡泡、LOVELYS 娃娃或其他 TWICE 周邊
一人限一
...
因前幾次的經驗加上數量有限，這次會採用隨意走動停留的方式發放，主要集中在 3/21、3/22，也可以看 IG 限動抓看看我。

想交換的萬斯歡迎私訊，但還是會依時間考量挑選。
高雄場應援有一些餘量也會一起發。
...
這次袋子繪製比較多元素，圖比較小，有些地方可能印刷不是很清楚，請大家多多諒解。
...
發放地點和時間：
當天會在 Threads 和 X 發文公告

領取規則：
A. 特殊領取
有參與動物應援的朋友，下週會提供表單填寫保留
當天沒有在時間內抵達，會直接取消保留

B. 一般領取
1. 手提袋和壓克力夾只能二選一
2. 出示本篇貼文 + 粉絲證明（如手燈、小卡、周邊等任一種皆可）
...
應援物：
不織布飲料 T 字提袋（26 × 13 cm）

發放數量：
目前預計每人 3 個
因為廠商做錯量，數量真的很多，歡迎大家伸手拿

領取資格：
應援棒、門票、小卡、周邊，任何可以證明是 ONCE 的東西都可以

另外也有準備交換應援的吊飾，歡迎大家可以跟我交換。
